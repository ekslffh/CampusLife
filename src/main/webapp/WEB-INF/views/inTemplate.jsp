...
<security:authentication property="principal.accType" var="type" />
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <c:choose>
        	<c:when test="${type == 'STD'}">
        		<%@ include file="/student/sidebar.jsp" %>
        	</c:when>
        	<c:when test="${type == 'PRF'}">
        		<%@ include file="/professor/sidebar.jsp" %>
        	</c:when>
        	<c:when test="${type == 'STF'}">
