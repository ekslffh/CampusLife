...
<!-- 									value="자동 생성" onclick="autofillButton()"> -->
								<form:form method="post" modelAttribute="prof" id="profForm"
									...
									<table class="table table-border">
										<tr>
											...
											<form:input path="profNm" class="form-control" maxlength='10' style="width:200px;" />
											<form:errors path="profNm" class="error" /></td>
										</tr>
										<tr>
											<th>전화번호</th>
											<td style="padding: 9px 0px 9px 15px;">
												<form:input path="profTel" class="form-control" maxlength='15' style="width:200px;" />
											</td>
										</tr>
										<tr>
											<th>성별</th>
											<td style="padding: 9px 0px 9px 15px;">
												<label> 
													<input type="radio" name="profGender" value="F" id="femaleRadio" /> 여성 <br>
												</label> 
												<label> 
														<input type="radio" name="profGender" value="M" id="maleRadio" /> 남성
												</label>
											</td>
										</tr>
										...
										<tr>
											...
											<td style="padding: 9px 0px 9px 15px;">
												<div style="display: flex; align-items: center;">
													<form:input path="profEmail" class="form-control" style="width:200px;" />
												</div>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td style="display: flex; align-items: center; padding: 9px 0px 9px 15px;">
												<form:select path="profMajCd" id="majSelect" class="form-control" style="width:200px;" /> &nbsp;&nbsp; 
<!-- 												<input class="btn btn-light btn-sm" onclick="findMajor()" value="전공 찾기" style="width: 80px;">  -->
										...
										<tr>
											<th>우편번호</th>
											<td style="display: flex; align-items: center; padding: 9px 0px 9px 15px;">
												<form:input id="prof_postNo" path="profPostNo" class="form-control" style="width:200px;" /> &nbsp;&nbsp; 
												<input class="btn btn-light btn-sm" onclick="findAddr()" value="주소 찾기" style="width: 80px;"> 
												<form:errors path="profPostNo" class="error" /></td>
										</tr>
										<tr>
											<th>주소</th>
											<td style="padding: 9px 0px 9px 15px;">
												<form:input id="prof_addr" path="profAddr" class="form-control" />
											</td>
										</tr>
										<tr>
											<th>상세 주소</th>
											<td style="padding: 9px 0px 9px 15px;">
												<form:input path="profDetailAddr" class="form-control" style="width:200px;" />
											</td>
										</tr>
										<tr>
											<th>입사일</th>
											<td style="padding: 9px 0px 9px 15px;">
												<form:input path="profJoinDt" class="form-control" type="date" style="width:200px;" />
											</td>
										</tr>
										<tr>
											<th>국적</th>
											<td style="padding: 9px 0px 9px 15px;">
												<form:input path="profCountry" class="form-control" style="width:200px;" />
											</td>
										</tr>
										<tr>
											<th>프로필</th>
											<td style="padding: 9px 0px 9px 15px;">
<!-- 											<input type="file" name="profProfile" multiple /> -->
											</td>
										</tr>
									</table>
	...
	function findAddr() {
		new daum.Postcode({
			oncomplete : function(data) {
				...
				document.getElementById('prof_postNo').value = data.zonecode;
				if (roadAddr !== '') {
					document.getElementById("prof_addr").value = roadAddr;
				} else if (jibunAddr !== '') {
					document.getElementById("prof_addr").value = jibunAddr;
				}
			}
		}).open();
	}
